...
export default function ExampleCarousel() {
    ...
    return (
        <section id="Examples" className='mb-32 grid place-items-center container mx-auto px-4'>
            ...
            <h2 className="text-center font-bold text-xl md:text-3xl lg:text-3xl relative z-50">Aumenta l’efficienza della <span className="text-transparent  bg-clip-text bg-gradient-to-r from-emerald-300 via-emerald-400 to-emerald-500">tua comunicazione</span></h2>
            </hgroup>
